            ...
            enum {
               ...
               : ArgTypeIsRowMajor,
                ...
                FlagsLinearAccessBit         = (RowsAtCompileTime == 1 || ColsAtCompileTime == 1 ||
                                                (InnerPanel && (evaluator<ArgType>::Flags & LinearAccessBit))) ? LinearAccessBit : 0,
...
// no direct-access => dispatch to a unary evaluator
        ...
        struct unary_evaluator<Block<ArgType, BlockRows, BlockCols, InnerPanel>, IndexBased>
            ...
            explicit unary_evaluator(const XprType& block)
                ...
                m_linear_offset(ForwardLinearAccess?(ArgType::IsRowMajor ? block.startRow() * block.nestedExpression().cols() + block.startCol() : block.startCol() *
                                                     block.nestedExpression().rows() + block.startRow()):0) {
            }

        ...
        struct traits<IndexedView<XprType, RowIndices, ColIndices> >
            ...
            enum {
               ...
               : XprTypeIsRowMajor,
                ...
                IsInnerPannel                = HasSameStorageOrderAsXprType && is_same<AllRange<InnerSize>,
                                                                                       typename conditional<XprTypeIsRowMajor, ColIndices, RowIndices>::type>::value,
    ...
    namespace internal {
        ...
        struct unary_evaluator<IndexedView<ArgType, RowIndices, ColIndices>, IndexBased>
            ...
            enum {
                ...
                Flags                = (evaluator<ArgType>::Flags & (HereditaryBits & ~RowMajorBit /*| LinearAccessBit | DirectAccessBit*/)) | FlagsLinearAccessBit |
                                       FlagsRowMajorBit,

...
namespace Eigen {
    namespace internal {
        ...
        EIGEN_ALWAYS_INLINE void bload(
        ...
        template<typename Packet>
        EIGEN_ALWAYS_INLINE void bscale(
            PacketBlock<Packet, 4>& acc,
        ...
        EIGEN_ALWAYS_INLINE void bscalec(
            PacketBlock<Packet, N>& aReal,
...
// Grab two decouples real/imaginary PacketBlocks and return two coupled (real/imaginary pairs) PacketBlocks.
        ...
        template<typename Packet, typename Packetc>
        EIGEN_ALWAYS_INLINE void bcouple(PacketBlock<Packet, 4>& taccReal, PacketBlock<Packet, 4>& taccImag, PacketBlock<Packetc, 8>& tRes, PacketBlock<Packetc, 4>& acc1,
        ...
        template<typename Packet, typename Packetc>
        EIGEN_ALWAYS_INLINE void bcouple(PacketBlock<Packet, 1>& taccReal, PacketBlock<Packet, 1>& taccImag, PacketBlock<Packetc, 2>& tRes, PacketBlock<Packetc, 1>& acc1,
        ...
        template<>
        EIGEN_ALWAYS_INLINE void bcouple_common<Packet2d, Packet1cd>(PacketBlock<Packet2d, 4>& taccReal, PacketBlock<Packet2d, 4>& taccImag, PacketBlock<Packet1cd, 4>& acc1,
        ...
        template<>
        EIGEN_ALWAYS_INLINE void bcouple_common<Packet2d, Packet1cd>(PacketBlock<Packet2d, 1>& taccReal, PacketBlock<Packet2d, 1>& taccImag, PacketBlock<Packet1cd, 1>& acc1,

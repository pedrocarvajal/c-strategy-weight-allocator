...
//---------- float ----------
        ...
        template<> struct unpacket_traits<Packet2cf> { typedef std::complex<float> type;
                                                       enum { size=2, alignment=Aligned16, vectorizable=true, masked_load_available=false, masked_store_available=false };
                                                       typedef Packet2cf half; typedef Packet4f as_real; };
...
//---------- double ----------
        ...
        template<> struct unpacket_traits<Packet1cd> { typedef std::complex<double> type;
                                                       ...
                                                       typedef Packet1cd half; typedef Packet2d as_real; };
        ...
        template<> EIGEN_STRONG_INLINE Packet1cd pset1<Packet1cd>(const std::complex<double>&  from) {/* here we really have to use unaligned loads :( */

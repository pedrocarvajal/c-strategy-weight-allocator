...
#define EIGEN_ALIGNED_ALLOCA(SIZE) reinterpret_cast<void *>((internal::UIntPtr(EIGEN_ALLOCA(SIZE + EIGEN_DEFAULT_ALIGN_BYTES - 1)) + EIGEN_DEFAULT_ALIGN_BYTES - 1) & \
...
#define ei_declare_aligned_stack_constructed_variable(TYPE, NAME, SIZE, BUFFER) \
        ...
        Eigen::internal::aligned_stack_memory_handler<TYPE> EIGEN_CAT(NAME, _stack_memory_destructor)((BUFFER) == 0 ? NAME : 0, SIZE, \
...
#define ei_declare_local_nested_eval(XPR_T, XPR, N, NAME) \
        Eigen::internal::local_nested_eval_wrapper<XPR_T, N> EIGEN_CAT(NAME, _wrapper)(XPR, reinterpret_cast<typename XPR_T::Scalar *>( \
                                                                                           ((Eigen::internal::local_nested_eval_wrapper<XPR_T, \
                                                                                                                                        N>::NeedExternalBuffer) && \
            ...
            for (int i = 0; i < 14; ++i) {
                switch (bytes[i]) {
                    ...
                    case 0x49: if (l2 != 0) {
                            ...
                            check_for_p2_core2 = true; l3 = l2 = 4096;

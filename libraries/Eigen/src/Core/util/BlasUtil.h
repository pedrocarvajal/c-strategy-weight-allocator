...
// because some features makes less sense in this case.
        ...
        public:
            ...
            struct storePacketBlock_helper {
                ...
                EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE void store(const blas_data_mapper<Scalar, Index, StorageOrder, AlignmentType, Incr> *sup, Index i, Index j,
            ...
            struct storePacketBlock_helper<SubPacket, ScalarT, n, -1> {
                EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE void store(const blas_data_mapper<Scalar, Index, StorageOrder, AlignmentType, Incr> *, Index, Index,
 ...
 * and conjugate */
        template<typename XprType> struct blas_traits {
            ...
            static inline EIGEN_DEVICE_FUNC const Scalar extractScalarFactor(const XprType&) {
                return Scalar(1);
            }
        };

 ...
 */
    ...
    public:
        ...
        EIGEN_DEVICE_FUNC inline typename internal::traits<Derived>::Coefficients& coeffs() {
            return derived().coeffs();
        }
...
//  { return operator=<Derived>(other); }
         ...
         */
        EIGEN_DEVICE_FUNC inline Scalar norm() const {
            return coeffs().norm();
        }

        /** Normalizes the quaternion \c *this
         * \sa normalized(), MatrixBase::normalize() */
        EIGEN_DEVICE_FUNC inline void normalize() {
            coeffs().normalize();
        }
        ...
        EIGEN_DEVICE_FUNC Derived& setFromTwoVectors(
        ...
        template<class OtherDerived> EIGEN_DEVICE_FUNC Quaternion<Scalar> slerp(
            const Scalar& t,
 ...
 */
    ...
    public:
        ...
        EIGEN_DEVICE_FUNC inline Coefficients& coeffs() {
            return m_coeffs;
        }

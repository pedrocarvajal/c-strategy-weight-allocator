...
namespace Eigen {
    namespace internal {
        ...
        template <typename BlockScalarVector, typename ScalarVector, typename IndexVector>
        EIGEN_DONT_INLINE void LU_kernel_bmod<SegSizeAtCompileTime>::run(const Index segsize, BlockScalarVector& dense, ScalarVector& tempv, ScalarVector& lusup, Index& luptr,
                                                                         const Index lda,
